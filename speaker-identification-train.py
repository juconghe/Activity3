...
precision_Karen = sum_conf[1,1]/(sum(sum_conf[:, 1])*1.0)
print("Precision of Karen is {}".format(precision_Karen))
recall_Karen= sum_conf[1,1]/(sum(sum_conf[1])*1.0)
print("Recall of Karen is {}".format(recall_Karen))
precision_Weihai = sum_conf[2,2]/(sum(sum_conf[:, 2])*1.0)
print("Precision of Weihai is {}".format(precision_Weihai))
recall_Weihai = sum_conf[2,2]/(sum(sum_conf[2])*1.0)
print("Recall of Weihai is {}".format(recall_Weihai))
